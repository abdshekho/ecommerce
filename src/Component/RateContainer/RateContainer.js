    ...
    return (
        <div className='mt-10 pb-10'>
            <div className='flex items-center'>
                ...
                <span className='flex text-yellow-700 pr-1 text-sm md:text-lg '> <FaStar className='pt-1' /> { rateAvg }</span> <span className='text-xs font-bold pl-1'>({ rateQty } Rates)</span>
            </div>
            <div className="flex items-center">
