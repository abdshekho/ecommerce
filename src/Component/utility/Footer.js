        ...
        <div className='bg-[#f2f1f6d1] p-4 mt-20 '>
            ...
            <div className='container flex justify-between items-center flex-col  md:flex-row gap-20'>
                ...
                <div className='flex items-center justify-center bg-blue-gray-700 rounded-lg shadow-2xl w-[90px] h-[90px]'>
                    <img src={ logo } className='' alt='' width={ 90 } height={ 90 } />
                </div>
                <div className='flex flex-colr items-center text-gray-600 justify-center md:justify-start gap-4'>
                    <Tooltip content={ "https://github.com/abdshekho" } className="bg-gray-800" animate={ animateTooltip }>
                        <a href='https://github.com/abdshekho' target="_blank" rel="noreferrer">
                    ...
                    <Tooltip content={ "https://www.linkedin.com/in/abd-shekho/" } className="bg-[#4267B2]" animate={ animateTooltip }>
                        <a href='https://www.linkedin.com/in/abd-shekho/' target="_blank" rel="noreferrer">
                    ...
                    <Tooltip content={ "https://www.facebook.com/abd.shekho/" } className="bg-[#4267B2]" animate={ animateTooltip }>
                        <a href='https://www.facebook.com/abd.sheko/' target="_blank" rel="noreferrer">
                    ...
                    <Tooltip content={ " +9639 536 796 41 " } className="bg-[#128C7E]" animate={ animateTooltip }>
                        <a className='hover:text-[#128C7E] cursor-pointer' href='https://api.whatsapp.com/send?phone=+963953679641&text=%22' target="_blank" rel="noreferrer">
                    ...
                    <Tooltip content={ " +9639 536 796 41 " } className="bg-gray-800" animate={ animateTooltip }>
                        <a className='cursor-pointer   hover:text-gray-800' href='tel:[+963953679641]' target="_blank" rel="noreferrer">
                ...
                <div className='flex md:flex-col gap-3 justify-center text-center'>
                    <a href='https://www.linkedin.com/in/abd-shekho/' className='mx-2 text-gray-600 hover:text-mainBlue'>About Us</a>
                    <a href='https://www.linkedin.com/in/abd-shekho/' className='mx-2 text-gray-600 hover:text-mainBlue'>Contact Us</a>
                    <a href='https://www.linkedin.com/in/abd-shekho/' className='mx-2 text-gray-600 hover:text-mainBlue'>Projects</a>
                </div>
            </div>
        </div>
    )
