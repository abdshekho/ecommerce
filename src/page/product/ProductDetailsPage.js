        ...
        <div className=''>
            ...
            <div className='container  block md:grid-cols-12 md:grid  mt-10'>
                ...
                <div className='col-span-8 mb-10 md:mb-0'>
                    <DetailsProduct id={ item._id } title={ item.title } category={ category } description={ item.description } price={ item.price } brand={ brand } colors={ item.availableColors } rateAvg={ rateAvg } favProduct={ favProduct } />
                </div>
            </div>
